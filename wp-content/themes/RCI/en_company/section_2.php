					...
					<div class="chronology-item text-center item">
						...
						<div class="inner-des-carousel description">
							...
							<div class="description-text">
								<p style="text-align: justify; color:#838383; font-size: 16px;">RCI Global Services was created in 2010 after realizing the lack of IT expertise in Asia-Pacific’s luxury retail industry. Its mission is to offer European and US technology and proficiency, combined with local knowledge and awareness. In merely 7 years, RCI Global Services has gained the unwavering trust of the most prestigious international retailers including Gucci, Fendi, Valentino, Céline, Bottega Veneta or&nbsp;Godiva.</p>
				...
				<div class="owl-item" style="width: 1349px; margin-right: 10px;">
					<div class="chronology-item text-center item">
						...
						<div class="inner-des-carousel description">
							...
							<div class="span">
								<p style="text-align: justify; color:#838383;">
									<span class=" font_content" style="font-size: 12pt;">RCI opens its first office abroad in Shenzhen, China.</span>
								</p>
							</div>
						</div>
						<div class="container">
				...
				<div class="owl-item" style="width: 1349px; margin-right: 10px;">
					<div class="chronology-item text-center item">
						...
						<div class="inner-des-carousel description">
							...
							<div class="span">
								<p style="text-align: justify; color:#838383;">
									<span class=" font_content" style="font-size: 12pt;">RCI opens its second office abroad in Seoul, South Korea.</span>
								</p>
							</div>
						</div>
						<div class="container">
				...
				<div class="owl-item" style="width: 1349px; margin-right: 10px;">
					<div class="chronology-item text-center item">
						...
						<div class="inner-des-carousel description">
							...
							<div class="span">
								<p style="text-align: justify; color:#838383;">
									<span class=" font_content" style="font-size: 12pt;">In 2015, Demandware (now Salesforce Commerce Cloud) certified RCI as a LINK Service Partner. Thanks to their expertise, RCI can propose to its clients the Salesforce Commerce Cloud E-commerce solution to build online stores.</span>
								</p>
							</div>
						</div>
						<div class="container">
				...
				<div class="owl-item" style="width: 1349px; margin-right: 10px;">
					<div class="chronology-item text-center item">
						...
						<div class="inner-des-carousel description">
							...
							<div class="span">
								<p style="text-align: justify; color:#838383;">
									<span class=" font_content" style="font-size: 12pt;">In 2016, RCI Global Services developed its own OMS solution called OMS Pro. It is integrated with Salesforce Commerce Cloud E-commerce solution and other back-end solutions as ERP, CRM or POS. With OMS Pro, retailers have a global view on online orders, inventory or client database. It is available in several languages and allows to manage different brands in different countries.</span>
								</p>
							</div>
						</div>
						<div class="container">
