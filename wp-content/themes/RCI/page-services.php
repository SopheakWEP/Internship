		...
		<?php get_header(); ?>
		<div class="rci-client heading-content">
			<img class="img-responsive" id="background-image-client" src="http://rciapac.com/wp-content/uploads/2017/03/Services-2.jpg" alt="">
						...
						<div class="container">
							<div class="row">
								...
								<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
									<h1 class="text-center wow slideInUp" data-wow-duration="0.5s" data-wow-delay="0.2s" style="color: #000;">RCI's Services</h1>
									<h3 class="text-center text-2 wow slideInUp" data-wow-duration="1s" data-wow-delay="0.3s" id="fade-border" style="color: #000; line-height: 3;" >An expertise dedicated to your performance.</h3>
									<div class="wow slideInUp" data-wow-duration="1.5s"data-wow-delay="0.4s"></div>
									<div class="border_ruler" data-wow-duration="2s" data-wow-delay="0.5s" style="color: #000;"></div>
									<p class="text-center-1 wow slideInUp" data-wow-duration="2s" data-wow-delay="0.5s" style="color: #000;">
					...
					<div class="col-xs-12 col-sm-12 col-md-4 text-center services-items">
						...
						<div class="services-description">
							...
							<ul class="list_service" style="list-style-type: square;">
								...
								<li>Customer insights &amp; segmentation</li>
								<li>Inventory management</li>
								<li>Promotion strategies</li>
								<li>Store sales &amp; profitability</li>
								<li>Retail analytics</li>
								<li>Visual merchandising</li>
								<li>Vendor &amp; franchise management</li>
							</ul>
							<p>
							</p></div>
						</div>						
						<div class="col-xs-12 col-sm-12 col-md-4 text-center services-items">
							...
							<div class="services-description">
								<h2>IT consultant</h2>
								<p class="paragraph_rci">Since each retailer has different type of business and needs, RCI decided to provide tailor-made&nbsp;services to help its clients to achieve their goals. At RCI, our team manages the whole project from the consulting until the support if necessary.</p><br>
								<ul class="list_service" class="fa-ul" style="list-style-type: square;">
									<li>IT strategy</li>
						...
						<div class="col-xs-12 col-sm-12 col-md-4 text-center services-items">
							<div class="services-image text-center">
								...
								<div class="services-description">
									...
									<p class="paragraph_rci">The system integration is a necessary step to create a unified commerce. RCI Global Services develops interfaces so that the information can be transferred. As online shoppers are increasing, retailers can link their physical stores to their online stores.</p><br>
									<ul class="list_service" style="list-style-type: square;">
										<li>E-commerce</li>
				...
				<section class="tailored-service">
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-md-10">
								<h2 class="heading text-center tailored_title">Tailored Services</h2>
								<span class="sub-heading dark-blue text-center">Every retailer has a different type of business and needs. Because of these differences, RCI Global Services adapts the solutions and the services to fit retailers' purpose.</span>
							</div>
							<div class="col-md-1"></div>
						</div>
						<div class="row">
							<div class="col-xs-12 col-sm-12 col-md-4 text-center services-items">
								...
								<div class="services-description">
									<h2>Consulting</h2>
									<p class="text_proccess">With its omnichannel expertise, RCI Global Services advises retailers about the most effective IT solutions to enhance their business. Since the way consumers go shopping is evolving, retailers seek&nbsp;innovative technologies that will increase productivity and customer experience.</p>
								</div>
							</div>						
							<div class="col-xs-12 col-sm-12 col-md-4 text-center services-items">
								<div class="services-image text-center">
								...
								<div class="services-description">
									...
									<p class="text_proccess">During the project, RCI Global Services oversees the solution implementation. With the third parties, RCI implements not only the E-commerce website&nbsp;but also OMS and POS solutions. Since RCI is headquartered in Hong Kong, the rollout&nbsp;can be organized in different countries in Asia-Pacific.</p>
								</div>
							</div>						
							<div class="col-xs-12 col-sm-12 col-md-4 text-center services-items">
								<div class="services-image text-center">
								...
								<div class="services-description">
									<h2>Support</h2>
									<p class="text_proccess">Since the provided solutions are complex and require IT knowledge, RCI Global Services offers&nbsp;technical support and assistance to its clients&nbsp;once the project is completed. In addition, the local support team can speak Cantonese, Mandarin and English.</p>
								</div>
							</div>						
						</div>
					</div>
				...
				<section class="section-services">
					<div class="container">
						<div class="row">
							...
							<div class="col-md-8">
								<h2 class="heading text-center">RCI's project management process</h2>
								<div class="intro"><p class="text_proccess">RCI Global Services offers a tailor made retail management solution, mixing retail strategies and IT operations, which is fully integrated into a 360° service. RCI Global Services’&nbsp;pioneering omnichannel retailing solution streamlines and enhances your businesses with its&nbsp;extensive retail expertise and a global network of IT solutions.</p>
									<p class="text_proccess">RCI Global Services addresses the needs of your organization, aiming to help your business thrive in its international expansion. A close and long-term partnership is forged between you and RCI Global Services, enabled by its&nbsp;capacity to anticipate and cater to your every need and challenge.</p>
								</div>
							</div>
							<div class="col-md-2"></div>
						</div>
