				...
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
							<h1 class="text-center wow slideInUp" data-wow-duration="0.5s" data-wow-delay="0.2s" style="color: #000;">Any request?</h1>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6">
				...
				<ul>
					<li class="ecomemrce" style="text-align: left;">Integrate online and offline channels in key markets or countries and manage different brands in different countries.</li>
				</ul>
				<ul>
...
<section style="background: #f5f2f2; padding-bottom: 50px; padding-top: 50px;">
	<div class="container">
		<div class="row">
			<div class="col-md-3"></div>
			<div class="col-md-6">
				<h2 class="text-center ecomemrce">O2O expert</h2>
				<p class="solution_justify ecomemrce">In the framework of an omnichannel strategy, O2O services aim to generate more online and in-store traffic by creating a unified and connected business. The services display all the purchasing process for different channels: web, mobile application or in-store. In the end, the retailers enhance their business and sales by providing a better customer experience.</p>
			</div>
			<div class="col-md-3"></div>
		</div>
		<div class="row">
		...
		<div class="row">
			<div class="col-md-6">
				<h2 class="ecomemrce">Online to Offline</h2>
				<p class="solution_justify ecomemrce">
				...
				<ul style="list-style-type: disc;">
					<li class="text_aline_justify ecomemrce">Stock visibility</li>
					<li class="text_aline_justify ecomemrce">Click &amp; collect</li>
					<li class="text_aline_justify ecomemrce">Click &amp; reserve</li>
					<li class="text_aline_justify ecomemrce">Customers&nbsp;&amp; guided selling</li>
					<li class="text_aline_justify ecomemrce">Wish list</li>
					<li class="text_aline_justify ecomemrce">Buy online &amp; return in-store</li>
					<li class="text_aline_justify ecomemrce">Loyalty</li>
					<li class="text_aline_justify ecomemrce">Coupon &amp; voucher</li>
				</div>
				<div class="col-md-6">
				...
				<ul style="list-style-type: disc;">
					<li class="ecomemrce">Stock level</li>
					<li class="ecomemrce">Account &amp; newsletter</li>
					<li class="ecomemrce">Store extension &amp; endless aisle</li>
					<li class="ecomemrce">Digital receipt</li>
					<li class="ecomemrce">Buy-in &amp; return anywhere</li>
					...
					<div class="owl-stage-outer slideWarpaper">
						<div class="owl-stage" style="transform: translate3d(0px, 0px, 0px); transition: 0s; width: 1620px;">
							<div class="owl-item active cc" style="width: 540px;">
								<div class="background-tv" style="background-image:url('http://rciapac.com/wp-content/uploads/2017/03/E-co.png');">
								</div>
							</div>
							<div class="owl-item dd" style="width: 540px;" data-hash="retail-pro2">
							...
							<div class="owl-item aa" style="width: 540px;" data-hash="ivend2">
								<div class="background-tv" style="background-image:url('http://rciapac.com/wp-content/uploads/2017/03/POS-1.png');">
									<div class="video-container">
