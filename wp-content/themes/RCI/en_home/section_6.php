		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-4 text-justify services-items">
				...
				<div class="services-description">
					...
					<p class="font_content" style="text-align: justify;">Over the years, RCI Global Services&nbsp;enhanced its clients’ business&nbsp;with its understanding in omnichannel retailing. The company has experience in store opening and contributed to implement IT solutions.</p>
				</div>
			</div>						
			<div class="col-xs-12 col-sm-12 col-md-4 text-justify services-items">
				<div class="services-image text-center">
				...
				<div class="services-description">
					...
					<p class="font_content" style="text-align: justify;">RCI Global Services advises the retailers in Asia-Pacific about how to use IT software solutions in the most effective way. RCI realizes a diagnostic on the retailer’s business, then&nbsp;presents the different technical possibilities.</p>
				</div>
			</div>						
			<div class="col-xs-12 col-sm-12 col-md-4 text-justify services-items">
				<div class="services-image text-center">
				...
				<div class="services-description">
					...
					<p class="font_content" style="text-align: justify;">The system integration acts as a coordinated whole between the front-end and the back-end. In the context of an omnichannel strategy, RCI Global Services creates&nbsp;interfaces to connect the different IT software solutions.</p>
				</div>
			</div>
		</div><br>
		<div class="row">
