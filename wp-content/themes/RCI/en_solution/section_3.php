	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-8">
				...
				<p class="solution_justify ecomemrce" style="padding:15px 54px 0px 54px;">In the framework of an omnichannel strategy, O2O services aim to generate more online and in-store traffic by creating a unified and connected business. The services display all the purchasing process for different channels: web, mobile application or in-store. In the end, the retailers enhance their business and sales by providing a better customer experience.</p>
			</div>
			<div class="col-md-2"></div>
		</div>
		<div class="row">
