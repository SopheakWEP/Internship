			...
			<div class="col-xs-12 col-sm-12 col-md-6 solution-description wow fadeIn" style="visibility: visible; animation-name: fadeIn;">
				...
				<div class="tab-content">
					<div role="tabpanel" class="tab-pane fade" id="oms-pro">
						<h4 >
							<span class="font_title" style="font-size: 14pt;">Orders and returns</span>
						</h4>
						...
						<h4  style="text-align: justify;">
							<span class="font_title" style="font-size: 14pt;">Real-time visibility</span>
						</h4>
						...
						<h4 style="text-align: justify;">
							<span class="font_title" style="font-size: 14pt;">Store fulfillment</span>
						</h4>
						<p class="font_content" style="text-align: justify;">Since OMS Pro can be integrated with E-commerce website and other complex software solutions as ERP, CRM or POS: local stores may directly fulfill online orders and send them to their clients. Last but not least, in the context of an omnichannel strategy, online orders can also be picked up in-stores.</p>
					</div>
